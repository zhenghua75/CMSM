...
namespace CMSM.Print
{
	...
	public class PrintElement
	{
		...
		{
			AddPrimitive(new PrintFourPrimitiveText(buf1,buf2,buf3,buf4));
		}
		public void AddTwoText(string buf1,string buf2)
		{
			AddPrimitive(new PrintPairPrimitiveText(buf1,buf2));
		}
