...
namespace CMSM.CMSMApp
{
	...
	public class frmProductionInStorage : CMSM.CMSMApp.frmBase
	{
		...
		private void sbtnOk_Click(object sender, System.EventArgs e)
		{
			...
			if(err!=null)
			{
				MessageBox.Show("操作失败，请重试！","系统提示",System.Windows.Forms.MessageBoxButtons.OK,System.Windows.Forms.MessageBoxIcon.Error);
				clog.WriteLine(err);
			}
			else
			{				
		...
		private void DgBind()
		{
			if(dtConsItem!=null)
			{
				...
				this.EnToCh("编号,商品编号,商品名称,单价,数量","100,100,170,100,100",dtConsItem,this.dataGrid1);
			}
		}
